...
/**
 * A simple example showing how to allocate
 * cloudlets to vms in sequence.
 */
public class ExtendedExample1 {

	/** The cloudlet list. */
	private static List<Cloudlet> cloudletList;
	private static int cloudletNum=5;
	...
	public static void main(String[] args) {
		...
		Log.printLine("Starting ExtendedExample1...");
		...
		try {
			...
			//will submit the bound cloudlets to VMs in sequence
			...
			Log.printLine("ExtendedExample1 finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
